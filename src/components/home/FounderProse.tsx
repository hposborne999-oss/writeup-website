        ...
        <div className="grid gap-12 lg:grid-cols-[1fr_300px] lg:gap-16 lg:items-center">
          ...
          <div className="max-w-[640px]">
            ...
            <div className="text-[18px] lg:text-[21px] leading-[1.6] text-ink">
              <p className="m-0 mb-[22px]">
                ...
                using AI in my own practice to speed up my QA process by
                flagging any errors and inconsistencies.
              </p>
              <p className="m-0">
          ...
          <div className="max-w-[280px] lg:max-w-none">
            <Image
              ...
              height={360}
              sizes="300px"
              className="w-full h-auto rounded-xl object-cover shadow-[0_24px_56px_-28px_rgba(10,34,38,0.4)]"
            />
          </div>
        </div>
      </Container>
